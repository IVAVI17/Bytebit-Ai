...
import { FaPlus, FaSearch, FaNotesMedical, FaCamera } from 'react-icons/fa';
...
export default function Dashboard() {
  ...
  const handleScanPrescription = () => {
    navigate(`/prescription_ocr/${hospital_id}`);
  };
          ...
          <div>
            <div className="d-flex justify-content-between align-items-center mb-4">
              ...
              <div className="d-flex gap-2">
                <button className="btn btn-secondary d-flex align-items-center" onClick={handleScanPrescription}>
                  <FaCamera className="me-2" /> Scan Prescription
                </button>
